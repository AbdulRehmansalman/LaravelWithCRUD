...
<body>
    ...
    <form action="{{url('/customer/update/'.$customer->customers_id)}}" method="POST">
        @csrf
        @method('PUT');
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6 required">
                        ...
                        <input type="text" name="country" class="form-control"
                            value="{{isset($customer)? $customer->country: ''}}">
                        <span class="text-danger">
                            @error('country')
                            {{message}}
                            @enderror
                ...
                <div class="row" style="display:flex;">
                    ...
                    <div class="form-group col-md-6 required">
                        ...
                        <input type="date" name="dob" value="{{isset($customer)? $customer->dob: ''}}">
                    </div>


                </div>
                <button class=" mt-3 btn btn-danger">Update</button>
            </div>
        </div>
